...
<x-sidebar collapsible="icon">
  ...
  <x-sidebar-footer class="group-data-[collapsible=icon]:hidden">
    <x-dropdown-menu class="block w-full">
      <x-dropdown-menu-trigger class="h-auto w-full justify-start gap-3 overflow-hidden border border-input bg-background px-3 py-2 shadow-xs hover:bg-accent">
        <div class="flex size-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-primary/15 text-xs font-semibold text-primary">
